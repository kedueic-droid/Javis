...
export function SideRail({ apps, logs, onSelect, onOpenSettings }: SideRailProps) {
  return (
    <aside className="relative z-10 hidden w-64 shrink-0 flex-col gap-4 px-4 pb-4 xl:flex">
